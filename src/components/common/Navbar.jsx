...
const Navbar = () => {
    ...
    // when user clicks Navbar link, it will hold yellow color
                            ...
                            {link?.title === "Catalog" ? (
                                ...
                                >
                                    ...
                                    >
                                        {/* Arrow */}
                                        <div
                                            className="absolute left-[50%] top-0 z-[100] h-6 w-6 translate-x-[80%]
                    ...
                    {user && user?.accountType !== "Instructor" && (
                        ...
                        >
                            <AiOutlineShoppingCart
                                className="text-[2.35rem] text-richblack-5 hover:bg-richblack-700
