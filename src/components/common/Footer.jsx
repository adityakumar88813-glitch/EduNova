...
// Images
import EduNovaLogo from "../../assets/Logo-Full-Light.png";
        ...
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <img src={EduNovaLogo} alt="" className="object-contain" />
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              <span> Made with ❤️ </span>
               {" "}
              <Link to='https://www.linkedin.com/in/aditya-kumar-1aaa17348' target="__blank" className="text-white hover:underline mr-1"
              >
              Aditya Kumar
              </Link>
            </div>
            <span> © 2026 EduNova</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/aditya-kumar-1aaa17348" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/adityakumar88813-glitch" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
